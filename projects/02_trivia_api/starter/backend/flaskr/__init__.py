...
def create_app(test_config=None):
    ...
    def get_paginated_questions():
        ...
        if current_questions in None: #I used to have 'if len(current_questions == 0:' this was producing 'JSONDecodeError: Expecting value: line 1 column 1 (char 0)'. Using 'is None' fixes that for cases where HTTP returns 404. 
            abort(404)
